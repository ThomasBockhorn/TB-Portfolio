        ...
        <div class = "flex flex-col">
            ...
            <div class = "flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                <div
                    ...
                    <div class = "p-4 flex flex-col">
                        <a class = "no-underline text-white text-2xl" href = "#">
                            $244
                        </a>
                        <a class = "no-underline text-white text-lg" href = "#">
                            Total Sales
                        </a>
                    </div>
                </div>
            ...
            <div
                ...
                <div class = "rounded rounded-t-lg overflow-hidden shadow max-w-xs my-3">
                    <img alt = "" class = "w-full" src = "https://i.imgur.com/w1Bdydo.jpg" />
                    <div class = "flex justify-center -mt-8">
                        <img alt = "" class = "rounded-full border-solid border-white border-2 -mt-3"
